...
export const tableFunctions = {
    ...
    specialColumnName(n) {
        let d = this.specialColumns();
        return _.get(d, n, null);
    },
    insertParam(url, key, value) {
        value = value || "";
        value = value + "";
        if (value.length <= 0) return this.removeParam(key, url);
        let _url = new URL(url);
        _url.searchParams.set(key, encodeURI(value));
        return _url.href;
    },
